...
import type { SessionEntry, SessionMessageEntry, ShakeConfig } from "jeopi-agent-core/compaction";
import {
...
import type { AssistantMessage, TextContent, ToolCall, ToolResultMessage } from "jeopi-ai";

...
```bash
npm install jeopi-ai
```

## Quick Start

```typescript
import { z, getModel, stream, complete, Context, Tool } from "jeopi-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "jeopi-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "jeopi-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "jeopi-ai";
...
```typescript
import { getModel, stream } from "jeopi-ai";
...
```typescript
import { getProviders, getModels, getModel } from "jeopi-ai";
...
```typescript
import { Model, stream } from "jeopi-ai";
...
```typescript
import { getModel, complete, Context } from "jeopi-ai";
...
```typescript
import { Context, getModel, complete } from "jeopi-ai";
...
```typescript
import { getEnvApiKey } from "jeopi-ai";
...
```typescript
import { loginGitHubCopilot } from "jeopi-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "jeopi-ai";
import * as fs from "node:fs";

...
import type { AssistantMessage, Message, Model, UserMessage } from "jeopi-ai/types";
 ...
 *
 * Reproduces the shape captured in `~/.jeopi/logs/http-400-requests/*.json` after Claude

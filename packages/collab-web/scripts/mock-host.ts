 ...
 * of the fixture JSONL — exactly the frames a real `jeopi /collab` host emits.
 */

import type { AgentSnapshot, HostFrame, SessionEntry, SessionState, WireFrame } from "jeopi-wire";

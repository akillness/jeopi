...
import { StatusLineComponent, type StatusLineSettings } from "jeopi-cli/modes/components/status-line";
import { STATUS_LINE_PRESETS } from "jeopi-cli/modes/components/status-line/presets";
import { initTheme } from "jeopi-cli/modes/theme/theme";
import * as git from "jeopi-cli/utils/git";
import { removeSyncWithRetries, setProjectDir } from "jeopi-utils";

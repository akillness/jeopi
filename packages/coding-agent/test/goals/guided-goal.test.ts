...
import * as core from "jeopi-agent-core";
...
import { runGuidedGoalTurn } from "jeopi-cli/goals/guided-setup";
...
import { AgentSession as RealAgentSession } from "jeopi-cli/session/agent-session";

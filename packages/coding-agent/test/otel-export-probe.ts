...
import { flushTelemetryExport, initTelemetryExport, isTelemetryExportEnabled } from "jeopi-cli/telemetry-export";
...
const span = trace.getTracer("jeopi-agent-core").startSpan("agent.llm_call");

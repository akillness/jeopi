...
import type { ReadyInfo, WorkerInbound, WorkerOutbound } from "jeopi-cli/tools/browser/tab-protocol";
import { initializeTabWorkerForTest } from "jeopi-cli/tools/browser/tab-supervisor";

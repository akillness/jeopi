...
import { handleCratesIo } from "jeopi-cli/web/scrapers/crates-io";
import { handleGoPkg } from "jeopi-cli/web/scrapers/go-pkg";
import { handleHex } from "jeopi-cli/web/scrapers/hex";
import { handleNpm } from "jeopi-cli/web/scrapers/npm";
import { handlePubDev } from "jeopi-cli/web/scrapers/pub-dev";
import { handlePyPI } from "jeopi-cli/web/scrapers/pypi";

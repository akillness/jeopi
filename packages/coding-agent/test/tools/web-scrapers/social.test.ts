...
import { handleReddit } from "jeopi-cli/web/scrapers/reddit";
import { handleStackOverflow } from "jeopi-cli/web/scrapers/stackoverflow";
import { handleTwitter } from "jeopi-cli/web/scrapers/twitter";

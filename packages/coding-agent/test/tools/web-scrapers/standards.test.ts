...
import { handleCheatSh } from "jeopi-cli/web/scrapers/cheatsh";
import { handleRfc } from "jeopi-cli/web/scrapers/rfc";
import { handleTldr } from "jeopi-cli/web/scrapers/tldr";

...
import { handleArxiv } from "jeopi-cli/web/scrapers/arxiv";
import { handleIacr } from "jeopi-cli/web/scrapers/iacr";
import { handlePubMed } from "jeopi-cli/web/scrapers/pubmed";
import { handleSemanticScholar } from "jeopi-cli/web/scrapers/semantic-scholar";
import type { RenderResult } from "jeopi-cli/web/scrapers/types";

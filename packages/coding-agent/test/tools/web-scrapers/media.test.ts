...
import { handleHuggingFace } from "jeopi-cli/web/scrapers/huggingface";
import { handleSpotify } from "jeopi-cli/web/scrapers/spotify";
import { handleVimeo } from "jeopi-cli/web/scrapers/vimeo";

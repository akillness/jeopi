...
import * as skillsModule from "jeopi-cli/extensibility/skills";
...
import { SKILL_PROMPT_MESSAGE_TYPE } from "jeopi-cli/session/messages";
...
function createSessionResult(session: AgentSession): CreateAgentSessionResult {
	return {
		session,
		extensionsResult: {} as unknown as import("jeopi-cli/extensibility/extensions/types").LoadExtensionsResult,
		setToolUIContext: () => {},

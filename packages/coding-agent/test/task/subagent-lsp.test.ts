...
import type { CreateAgentSessionOptions, CreateAgentSessionResult } from "jeopi-cli/sdk";
...
import type { AgentDefinition, TaskParams } from "jeopi-cli/task/types";
import type { IsolationHandle, WorktreeBaseline } from "jeopi-cli/task/worktree";

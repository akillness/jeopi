...
import { BtwPanelComponent } from "jeopi-cli/modes/components/btw-panel";
import { BtwController } from "jeopi-cli/modes/controllers/btw-controller";
...
import { Container, replaceTabs, type TUI } from "jeopi-tui";

/**
 * Issue #2462: prompt templates discovered from `cwd/.jeopi/prompts/` were never
...
import type { PromptTemplate } from "jeopi-cli/config/prompt-templates";
...
import type { AutocompleteProvider } from "jeopi-tui";

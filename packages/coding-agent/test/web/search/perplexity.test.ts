...
import { PerplexityProvider, searchPerplexity } from "jeopi-cli/web/search/providers/perplexity";
import { getAvailableAuthMethods } from "jeopi-cli/web/search/providers/perplexity-auth";

...
import { applyDisabledExtensionsToState } from "jeopi-cli/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "jeopi-cli/modes/components/extensions/types";

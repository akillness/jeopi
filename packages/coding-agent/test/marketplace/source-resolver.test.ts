...
import type { MarketplacePluginEntry } from "jeopi-cli/extensibility/plugins/marketplace";
import { resolvePluginSource } from "jeopi-cli/extensibility/plugins/marketplace";

...
import { resizeImage } from "jeopi-cli/utils/image-resize";
...
describe("resizeImage env wiring", () => {
	...
	it("treats JEOPI_NO_WEBP=1 set at call time as exclusion (not baked at module load)", async () => {
		Bun.env.JEOPI_NO_WEBP = "1";

...
import { getPrompt, listPrompts, serverSupportsPrompts } from "jeopi-cli/mcp/client";
import type { MCPGetPromptResult, MCPPrompt, MCPPromptsListResult } from "jeopi-cli/mcp/types";

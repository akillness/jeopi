...
// --target=bun-linux-arm64, embeds the matching native, outputs dist/jeopi-<target>.
...
const outName = crossTarget ? `jeopi-${crossTarget}` : "jeopi";
...
async function main(): Promise<void> {
	...
	try {
		...
		// `jeopi/export/html` (one of pi-coding-agent's

...
import jeoMd from "../prompts/agents/jeo.md" with { type: "text" };

const EMBEDDED_COMMANDS: { name: string; content: string }[] = [
	{ name: "init.md", content: prompt.render(initMd) },
	{ name: "jeo.md", content: prompt.render(jeoMd) },
];
 ...
 *
 * Precedence (highest wins): .jeopi > .pi > .claude (project before user), then bundled
 */

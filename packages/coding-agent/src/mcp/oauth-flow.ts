...
import type { OAuthCallbackFlowOptions } from "jeopi-ai/oauth/callback-server";
import { OAuthCallbackFlow } from "jeopi-ai/oauth/callback-server";
import type { OAuthController, OAuthCredentials } from "jeopi-ai/oauth/types";
import type { FetchImpl } from "jeopi-ai/types";
import { getActiveProfile } from "jeopi-utils/dirs";
...
/**
 * Deterministic credential id for an MCP server URL scoped to a jeopi profile.
 *

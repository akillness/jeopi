...
import { type AstReplaceChange, type AstReplaceFileChange, astEdit } from "jeopi-natives";
import type { Component } from "jeopi-tui";
import { replaceTabs, Text } from "jeopi-tui";
import { $envpos, prompt, untilAborted } from "jeopi-utils";

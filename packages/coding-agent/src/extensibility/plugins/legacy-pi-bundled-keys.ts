...
export const BUNDLED_PI_REGISTRY_KEYS: ReadonlySet<string> = new Set([
	...
	"@oh-my-pi/pi-coding-agent/cli/usage-error",
	...
	"@oh-my-pi/pi-coding-agent/exec/bash-cwd-sync",
	...
	"@oh-my-pi/pi-coding-agent/memories/okf",
	...
	"@oh-my-pi/pi-coding-agent/task/critic-gate",
	...
	"@oh-my-pi/pi-coding-agent/tools/path-write-lock",
	...
	"@oh-my-pi/pi-coding-agent/tools/subagent",
	...
	"@oh-my-pi/pi-coding-agent/tools/vision-verify",

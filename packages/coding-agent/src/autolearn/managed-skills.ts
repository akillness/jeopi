 ...
 * isolated directory (`~/.jeopi/agent/managed-skills`) separate from
 * user-authored skills (`~/.jeopi/agent/skills`). They are discovered and
...
/** Resolve the isolated managed-skills directory (`~/.jeopi/agent/managed-skills`). */

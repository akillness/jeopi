...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "jeopi-ai";
import { isPersonalGitHubCopilotBaseUrl } from "jeopi-catalog/wire/github-copilot";
...
// Per-provider image-count budgets live in jeopi-snapcompact

/**
 * `jeopi completions <bash|zsh|fish>` — print a shell completion script.
 *
 ...
 */
import { APP_NAME, VERSION } from "jeopi-utils";
import { Args, type CliConfig, Command, type CommandCtor } from "jeopi-utils/cli";

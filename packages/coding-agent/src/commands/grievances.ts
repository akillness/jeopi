...
export default class Grievances extends Command {
	...
	static args = {
		...
		// arg keeps the historical `jeopi grievances` invocation working unchanged
	...
	static examples = [
		"jeopi grievances",
		"jeopi grievances list --tool find",
		"jeopi grievances clean --id 209",
		"jeopi grievances clean --tool find",
		"jeopi grievances clean --all",
		"jeopi grievances push",
	];

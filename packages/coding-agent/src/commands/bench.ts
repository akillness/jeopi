...
export default class Bench extends Command {
	...
	static examples = [
		"# Compare two models\n  jeopi bench anthropic/claude-opus-4-5 openai/gpt-5.2",
		"# Fuzzy selectors work\n  jeopi bench opus sonnet",
		"# Average over 3 runs each\n  jeopi bench opus gpt-5.2 --runs 3",
		"# Force priority serving tier\n  jeopi bench openai-codex/gpt-5.5:low --runs 10 --service-tier priority",
		"# Machine-readable output\n  jeopi bench opus --json",
	];

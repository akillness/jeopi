 ...
 *
 * Usage:
 * 1. Copy this file to ~/.jeopi/agent/extensions/ (legacy: ~/.pi/agent/extensions/) or your project's .jeopi/extensions/
 * 2. Use /tools to open the tool selector
 */
import type { ExtensionAPI, ExtensionContext } from "jeopi-cli";
import { getSettingsListTheme } from "jeopi-cli";
import { Container, type SettingItem, SettingsList } from "jeopi-tui";

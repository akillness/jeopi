 ...
 * - ~/.jeopi/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.jeopi/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.jeopi/agent/extensions/ or .jeopi/extensions/

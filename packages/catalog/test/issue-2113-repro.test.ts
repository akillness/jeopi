...
import { type OpenAICompletionsOptions, streamOpenAICompletions } from "jeopi-ai/providers/openai-completions";
import type { AssistantMessage, Context } from "jeopi-ai/types";
...
import { moonshotModelManagerOptions } from "jeopi-catalog/provider-models/openai-compat";
import type { Model, ModelSpec } from "jeopi-catalog/types";

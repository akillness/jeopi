		...
		<aside className={`stats-nav-rail ${className}`}>
			<div className="stats-nav-rail-header">
				<div className="stats-logo-container">
					<span className="stats-logo-text">JEOPI</span>
					<span className="stats-logo-subtext">Encode intention. Decode software.</span>
				</div>
			</div>
			...
			<div className="stats-nav-rail-footer">
				<span className="stats-version-tag">jeopi stats v1.0.0</span>
			</div>
		</aside>
	);
}

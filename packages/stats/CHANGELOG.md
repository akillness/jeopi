...
- Bundled-model lookups (`getBundledModel`, `GeneratedProvider`) now import from the new `jeopi-catalog` package instead of the `jeopi-ai` barrel, which no longer re-exports catalog values

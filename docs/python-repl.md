...
2. Managed venv at `~/.jeopi/python-env`
...
- **No Python on PATH** — Install a system Python 3.8+ or place a venv at `~/.jeopi/python-env`. `omp setup python --check` reports the resolved interpreter.

...
- syntax highlighting colors used by native highlighter (`jeopi-natives`)
...
- default agent dir: `~/.jeopi/agent`
- effective default file: `~/.jeopi/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.jeopi/agent/themes/my-theme.json`.

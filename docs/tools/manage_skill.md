...
## Side Effects
- Filesystem: writes or deletes files under `~/.jeopi/agent/managed-skills`.
- Network: none.
...
## Notes
- Managed skills are generated under `~/.jeopi/agent/managed-skills` and never edit user-authored skills.

# jeopi Coding Agent Installer for Windows
# Usage: irm https://raw.githubusercontent.com/akillness/jeopi/jeopi/scripts/install.ps1 | iex
#
# Or with options:
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/akillness/jeopi/jeopi/scripts/install.ps1))) -Source
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/akillness/jeopi/jeopi/scripts/install.ps1))) -Binary
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/akillness/jeopi/jeopi/scripts/install.ps1))) -Source -Ref v3.20.1
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/akillness/jeopi/jeopi/scripts/install.ps1))) -Source -Ref main
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/akillness/jeopi/jeopi/scripts/install.ps1))) -Binary -Ref v3.20.1
...
$BinaryName = "jeopi-windows-x64.exe"
...
function Configure-BashShell {
    try {
        $settingsDir = Join-Path $env:USERPROFILE ".jeopi\agent"
...
function Install-ViaBun {
    ...
    Write-Host "Run 'jeopi' to get started!"
}
...
function Install-Binary {
    ...
    $OutPath = Join-Path $InstallDir "jeopi.exe"
    ...
    if ($needsRestart) {
        Write-Host "Restart your terminal, then run 'jeopi' to get started!"
    } else {
        Write-Host "Run 'jeopi' to get started!"
    }
}

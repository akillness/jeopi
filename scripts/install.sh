...
install_via_bun() {
    ...
    echo ""
    echo "✓ Installed jeopi via bun"
    echo "Run 'jeopi' to get started!"
}
...
install_binary() {
    ...
    # Check if in PATH
    case ":$PATH:" in
        *":$INSTALL_DIR:"*) echo "Run 'jeopi' to get started!" ;;
        *) echo "Add ${INSTALL_DIR} to your PATH, then run 'jeopi'" ;;
    esac
}

...
- **[16.3.0]** (2026-07-12) — Goal-mode completion now spawns an independent `goal-verifier` sub-agent (fresh context, no exposure to the maker's transcript/reasoning) to grade a `goal({op:"complete"})` claim against the…
